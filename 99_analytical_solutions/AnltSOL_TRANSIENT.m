...
n = 1;      % porosity 
Dx = 6;      % longiitudinal dispersivity - y-direction m2/s
Dy = 6;      % longiitudinal dispersivity - y-direction m2/s
r = 0;         % reaction rate
Xc = 330;        % injection location loation
Yc = 150;        % injection location loation
tsim = 200;      % time after injection - units: days
Zgw = 70;      % aquifer thinkness
V = -1.2;        % GW seepage flow velocity (m/day) (average intersticial velocity)
